...
<div data-table="table" class="panel">
    ...
    <ul class="nav nav-tabs">
        <li ${empty param['search.show_eq'] ? 'class="active"' : ''}>
            <a href="${ctx}/bussiness/product/product">
                <i class="icon-table"></i>
                所有产品列表
            </a>
        </li>
        <li ${param['search.show_eq'] eq 'true' ? 'class="active"' : ''}>
            <a href="${ctx}/bussiness/product/product?search.show_eq=true">
                <i class="icon-table"></i>
                可显示的产品列表
            </a>
        </li>
        <li ${param['search.show_eq'] eq 'false' ? 'class="active"' : ''}>
            <a href="${ctx}/bussiness/product/product?search.show_eq=false">
                <i class="icon-table"></i>
                隐藏的产品列表
            </a>
        </li>
    ...
    <div class="row-fluid tool ui-toolbar">
        <div class="span4">
            <div class="btn-group">
                ...
                <a class="btn btn-create" href="${ctx}/bussiness/product/product/find">
