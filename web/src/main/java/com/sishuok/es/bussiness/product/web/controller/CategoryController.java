...
import com.sishuok.es.bussiness.product.service.CategoryService;
 ...
 */
@Controller
@RequestMapping(value = "/bussiness/product/category")
public class CategoryController extends BaseMovableController<Category, Long> {


    public CategoryController() {
        setResourceIdentity("bussiness:productCategory");
    }
    ...
    public String select(
        ...
        return "bussiness/product/category/select";
    }
}
